 <?php
    ...
    if(isset($_POST['submit'])){
        ...
        $sql = " INSERT INTO `login_register`(`username`, `email_id`, `password`) VALUES ( '$username', '$email_id', '$password')";
...
<label> USER EMAIL ID: </label>
 ...
 <a class="btn btn-info" type="submit" name="cancel" href="login.php"> Login Page </a><br>
