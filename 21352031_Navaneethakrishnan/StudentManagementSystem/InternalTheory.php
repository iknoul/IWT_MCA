<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $sql = " INSERT INTO `internal_theory`(`register_number`, `Internal_1`, `Internal_2`, `Internal_3`) VALUES ( '$register_number', '$Internal_1', '$Internal_2', '$Internal_3')";
...
<html lang="en">
 ...
 <h1 class='text-white text-center'>  INTERNALTHEORY MARK REGISTER </h1>
 </div><br>
