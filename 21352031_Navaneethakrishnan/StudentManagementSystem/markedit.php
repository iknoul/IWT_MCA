...
<?php
  ...
  if($_SERVER["REQUEST_METHOD"]=='GET'){
    ...
    $sql = "select * from internal_theory where register_number=$register_number";
    ...
    $sql = "update internal_theory set register_number='$register_number', Internal_1='$Internal_1', Internal_2='$Internal_2', Internal_3=$Internal_3 where register_number='$register_number'";
    $result = $conn->query($sql);
